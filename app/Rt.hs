...
primitives = (HM.fromList . map \(x,y,z) -> (x, Def y z))
  ...
  , ("E", Val.FReshape, 0), ("s#", Val.FShape, 0), ("#", Val.FLength, 0), ("aE", Val.FDeshape, 0)
  , ("R", Val.FReverse, 0), ("X", Val.FExclude, 0), ("H", Val.FHead, 0), ("T", Val.FTail, 0)
  , ("zH", Val.FZeroHead, 0), ("N", Val.FNudge, 0)
  ...
  , ("?", Val.FMatches, 0), ("Y", Val.FYank, 0), ("K", Val.FKernel, 0), ("V", Val.FVector1, 0)
  , ("bV", Val.FVector2, 0), ("I", Val.FIota, 0)
  ...
  , ("f", Val.FFold, 1), ("r", Val.FReduce, 1), ("h", Val.FScan, 1)
  ]
